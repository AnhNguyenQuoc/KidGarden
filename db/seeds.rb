...
(1, 'HÀ NỘI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'HỒ CHÍ MINH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'HẢI PHÒNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 'ĐÀ NẴNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 'HÀ GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 'CAO BẰNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 'LAI CHÂU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 'LÀO CAI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 'TUYÊN QUANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10, 'LẠNG SƠN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11, 'BẮC KẠN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 'THÁI NGUYÊN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(13, 'YÊN BÁI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(14, 'SƠN LA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15, 'PHÚ THỌ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(16, 'VĨNH PHÚC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(17, 'QUẢNG NINH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(18, 'BẮC GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(19, 'BẮC NINH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(20, 'HẢI DƯƠNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(21, 'HƯNG YÊN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(22, 'HOÀ BÌNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(23, 'HÀ NAM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 'NAM ĐỊNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(25, 'THÁI BÌNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(26, 'NINH BÌNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(27, 'THANH HOÁ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 'NGHỆ AN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(29, 'HÀ TĨNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(30, 'QUẢNG BÌNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(31, 'QUẢNG TRỊ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(32, 'THỪA THIÊN HUẾ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(33, 'QUẢNG NAM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(34, 'QUẢNG NGÃI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(35, 'KONTUM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(36, 'BÌNH ĐỊNH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 'GIA LAI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38, 'PHÚ YÊN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(39, 'ĐĂK LĂK', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(40, 'KHÁNH HOÀ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41, 'LÂM ĐỒNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(42, 'BÌNH PHƯỚC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, 'BÌNH DƯƠNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, 'NINH THUẬN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 'TÂY NINH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(46, 'BÌNH THUẬN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(47, 'ĐỒNG NAI', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48, 'LONG AN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(49, 'ĐỒNG THÁP', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(50, 'AN GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(51, 'BÀ RỊA-VŨNG TÀU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(52, 'TIỀN GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(53, 'KIÊN GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(54, 'CẦN THƠ', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(55, 'BẾN TRE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(56, 'VĨNH LONG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(57, 'TRÀ VINH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(58, 'SÓC TRĂNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(59, 'BẠC LIÊU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(60, 'CÀ MAU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(61, 'ĐIỆN BIÊN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(62, 'DĂK NÔNG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(63, 'HẬU GIANG', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);")
